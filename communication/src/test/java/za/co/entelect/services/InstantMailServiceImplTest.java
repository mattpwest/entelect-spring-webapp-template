...
public class InstantMailServiceImplTest extends EmailTest {
    ...
    public void testQueueMail() throws MailDataException {
        ...
        Assert.assertNotNull("Mail sent time was not set.", mail.getSentAt());
        Assert.assertTrue("Number of mails received by SMTP server has not increased.", numEmailsSentAfterCall > numEmailsSent);
    }
}

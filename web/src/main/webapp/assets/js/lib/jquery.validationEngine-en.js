    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "name": {
                    "regex": /^([^0-9]*)$/,
                    "alertText": "No numbers allowed"
                },
                "phoneWithMask": {
                    "regex": /\D*([2-9]\d{2})(\D*)([2-9]\d{2})(\D*)(\d{4})\D*/,
                    "alertText": "Not a valid telephone number"
                },
                "lessThanEqualTo": {
                    "func": function(field, rules, i, options) {
                        var matchField = rules[i + 2],
                            matchFieldValue = parseInt($(matchField).val());
                        return parseInt(field.val()) <= matchFieldValue;
                    },
                    "alertText": "Too high value"
                },
                "moreThanEqualTo": {
                    "func": function(field, rules, i, options) {
                        var matchField = rules[i + 2],
                ...
                "idNumber": {
                    "func": function(field, rules, i, options) {
                        ...
                        return extractFromID(idNumber).valid;
                    },
